...
<div class="in">
  <div class="login" @keypress.enter="login">
    <div class="input">
      <el-input class="username" :placeholder="$t('local.login.username')" clearable v-model.lazy="username"></el-input>
      <el-input class="password" :placeholder="$t('local.login.password')" clearable show-password v-model.lazy="password"></el-input>
    </div>
    <el-button class="button" @click="login" v-t="{path:'local.login.login'}"></el-button>
  </div>
  <div class="exit"><i class="el-icon-switch-button"></i><span v-t="{path:'local.login.exit'}"></span></div>
</div>
</template>
